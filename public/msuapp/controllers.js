...
controllers.controller('mainController', ['$scope', '$timeout', function($scope, $timeout) {
    ...
    $scope.selectedContent = 'partials/locations/unlocation.jade';

    $scope.locationList = [{
        "url": 'partials/locations/location_1.jade',
        "latitude": 45.778304,
        "longitude": 15.981304
    }];
...
controllers.controller('mainControllerMobile', ['$scope', '$timeout', function($scope, $timeout) {
